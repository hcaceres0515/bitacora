      ...
      var locations = [
            {
                  ...
                  user: "asda",
                  name: SEARCH_ADDRESS,
                  avatar: "https://www.panoramicjourneys.com/resources/images/marker-clusterer-image.png",
                  lng: SEARCH_LNG,
                  lat: SEARCH_LAT,
                  description: "You want to go to Sogay "
            },
            {
                  _id : "12323",
                  user: "123213",
...
function setMarkers(map) {  
      ...
      for (var i = 0; i < beaches.length; i++) {
            ...
            marker.addListener('click', function() {
                  window.location.href = "/route-info.html";
